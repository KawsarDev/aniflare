...
function PopularPage() {
  ...
  useEffect(() => {
    axios
      .get(`https://animetize-api.vercel.app/popular?page=${page}`)
  ...
  return (
    <div>
      <h2 className="text-white text-lg px-3 font-bold my-1">Popular</h2>
            ...
            <div>
              <div className="relative">
                ...
                <div className="absolute bottom-0 bg-gradient-to-t from-zinc-950 to-transparent w-full">
                  <span className="bg-sky-200 text-sm text-black px-1 rounded m-1">
                    {anime?.releaseDate}
                  </span>
                </div>
              </div>
